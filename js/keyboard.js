import { keyboardsData } from "./keyboardData.js";
console.clear();
...
function isThaiLetter(letter) {
  return keyboardsData.some(
    (kb) => kb.tShift.text === letter || kb.tMain.text === letter
  );
}
...
function playLetter(mArr, nowIndex) {
  ...
  if (soundData.dur != 0) {
    ...
    document.querySelector(`.kb${soundData.id}`).style.backgroundColor =
      "#f9c500";
